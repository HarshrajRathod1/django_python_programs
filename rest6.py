...
def getall():
    response=requests.get(BASE_URL+'stud/')
    print(response)
    print(response.json())

def getstud():
    rno=int(input("Enter Student Rollno : "))
    response=requests.get(BASE_URL+'stud/'+str(rno)+"/")
    print(response)
    print(response.json())
...
def create_stud():
    ...
    response=requests.post(BASE_URL+'stud/',data=stud)
    print(response)
    print(response.json())

def delete_stud():
    rno=int(input("Enter Student No : "))
    response=requests.delete(BASE_URL+"stud/"+str(rno)+"/")
    print(response)
    print(response.json())
...
def update_stud():
    ...
    course=input('Enter Course : ')
    stud={'rno':rno,'name':name,'course':course}
    response=requests.put(BASE_URL+"stud/"+str(rno)+"/"+str(course)+"/",data=stud)
    print(response)
    print(response.json())
